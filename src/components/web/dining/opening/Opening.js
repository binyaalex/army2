	...
	return (
		<>
			...
			<div className="opening-hours"> 
				...
				{/*<div> 
					<div className="emphasis subtitle">ימי א'-ה':</div> 
						<div> 
							<img className="time" src="/images/s-morning.c53c11a0.svg"/> 
							<b>בוקר</b>: 
